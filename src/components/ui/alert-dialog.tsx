...
function AlertDialogOverlay({
  className,
  disableDefaultBlur = false,
  ...props
}: React.ComponentProps<typeof AlertDialogPrimitive.Overlay> & {
  disableDefaultBlur?: boolean
}) {
  return (
    <AlertDialogPrimitive.Overlay
      data-slot="alert-dialog-overlay"
      className={cn(
        "fixed inset-0 z-50 bg-background/75 duration-[var(--duration-instant)] data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0",
        !disableDefaultBlur && "supports-backdrop-filter:backdrop-blur-sm",
        className,
      )}
      {...props}
    />
  ...
  return (
    <AlertDialogPortal container={portalContainer}>
      <AlertDialogOverlay
        ...
        disableDefaultBlur={disableDefaultOverlayBlur}
      />
