...
function deletionCopy(kind: DeletedTaskNotice["kind"]) {
  ...
  if (kind === "missed") {
    return {
      description:
        "The missed-task penalty stays in Progress. You can restore this task today after choosing a new timeline.",
  ...
  return {
    description:
      "No points were deducted, and its value was removed from your planned total. You can restore it until today ends.",
